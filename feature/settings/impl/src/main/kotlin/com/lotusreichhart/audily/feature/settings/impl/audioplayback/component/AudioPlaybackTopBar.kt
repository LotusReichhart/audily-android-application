package com.lotusreichhart.audily.feature.settings.impl.audioplayback.component
...
@Composable
internal fun AudioPlaybackTopBar(
    onBack: () -> Unit,
    ...
    Row(
        ...
        Text(
            text = stringResource(R.string.feature_settings_impl_audio_title),
