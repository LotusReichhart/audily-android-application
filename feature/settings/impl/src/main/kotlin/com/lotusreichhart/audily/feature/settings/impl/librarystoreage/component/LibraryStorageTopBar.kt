package com.lotusreichhart.audily.feature.settings.impl.librarystoreage.component
...
@Composable
internal fun LibraryStorageTopBar(
    onBack: () -> Unit,
    ...
    Row(
        ...
        Text(
            text = stringResource(R.string.feature_settings_impl_library_title),
