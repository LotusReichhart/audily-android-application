...
internal fun SearchResultEmpty(
    ...
    val messageResId = when (type) {
        SearchType.ALL -> R.string.feature_search_impl_all_result_empty
        SearchType.SONGS -> R.string.feature_search_impl_songs_result_empty
        SearchType.ALBUMS -> R.string.feature_search_impl_albums_result_empty
        SearchType.PLAYLISTS -> R.string.feature_search_impl_playlists_result_empty
    }
    ...
    Column(
        ...
        Icon(
            ...
            contentDescription = "Result Empty",
