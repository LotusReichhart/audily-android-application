...
internal fun PlaylistsAddOrUpdateSheet(
    ...
    Column(
        ...
        // Playlist Name
        Text(
            text = stringResource(id = R.string.feature_playlists_impl_playlist_name),
        ...
        AudilyInputField(
            ...
            placeholder = stringResource(id = R.string.feature_playlists_impl_playlist_name_placeholder),
            maxLength = 30
        )
        ...
        // Description
        Text(
            text = stringResource(id = R.string.feature_playlists_impl_playlist_description_optional),
            style = MaterialTheme.typography.titleSmall,
            fontWeight = FontWeight.Bold,
            color = MaterialTheme.colorScheme.onSurfaceVariant
        )
        ...
        AudilyInputField(
            ...
            placeholder = stringResource(id = R.string.feature_playlists_impl_playlist_description_placeholder),
            singleLine = false,
