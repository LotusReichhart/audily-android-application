...
@Composable
internal fun QueueSavePlaylistSheet(
    onDismiss: () -> Unit,
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = stringResource(id = R.string.feature_nowplaying_create_playlist),
        ...
        // Playlist Name
        Text(
            text = stringResource(id = R.string.feature_nowplaying_playlist_name),
        ...
        AudilyInputField(
            ...
            placeholder = stringResource(id = R.string.feature_nowplaying_playlist_name_placeholder),
            maxLength = 30
        )
        ...
        // Description
        Text(
            text = stringResource(id = R.string.feature_nowplaying_playlist_description_optional),
            style = MaterialTheme.typography.titleSmall,
            fontWeight = FontWeight.Bold,
            color = MaterialTheme.colorScheme.onSurfaceVariant
        )
        ...
        AudilyInputField(
            ...
            placeholder = stringResource(id = R.string.feature_nowplaying_playlist_description_placeholder),
            singleLine = false,
